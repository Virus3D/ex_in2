...
use App\Form\ServiceMeterReadingType;
...
#[AsLiveComponent]
final class MeterReadingForm extends AbstractController
{
    ...
    {
        return $this->createForm(ServiceMeterReadingType::class, options: ['place' => $this->getPlace()]);
    }//end instantiateForm()
    ...
    public function save(): void
    {
        ...
        $this->serviceMeterReadingService->saveReading(
            $this->getPlace(),
            $data,
            $this->filterDataHelper->year
        );

        $this->emit('meterReadingAdded');
    }//end save()
