    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'CREATE TABLE place_service (
                ...
                INDEX IDX_D5518D29DA6A219 (place_id),
                INDEX IDX_D5518D29ED5CA9E6 (service_id),
                PRIMARY KEY(place_id, service_id)) DEFAULT
        ...
        $this->addSql(
            'CREATE TABLE service_account (
                ...
                month INT NOT NULL,
                amount INT NOT NULL,
                INDEX IDX_B2B20438ED5CA9E6 (service_id),
                INDEX IDX_B2B20438DA6A219 (place_id),
                PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB'
        );
        $this->addSql(
            'CREATE TABLE service_payment (
                ...
                INDEX IDX_A2ACD691ED5CA9E6 (service_id),
                INDEX IDX_A2ACD691DA6A219 (place_id),
                PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB'
        );
        $this->addSql(
            'ALTER TABLE place_service ADD CONSTRAINT FK_D5518D29DA6A219
                FOREIGN KEY (place_id) REFERENCES place (id) ON DELETE CASCADE'
        );
        $this->addSql(
            'ALTER TABLE place_service ADD CONSTRAINT FK_D5518D29ED5CA9E6
                FOREIGN KEY (service_id) REFERENCES service (id) ON DELETE CASCADE'
        );
        $this->addSql(
            'ALTER TABLE service_account ADD CONSTRAINT FK_B2B20438ED5CA9E6
                FOREIGN KEY (service_id) REFERENCES service (id)'
        );
        $this->addSql(
            'ALTER TABLE service_account ADD CONSTRAINT FK_B2B20438DA6A219
                FOREIGN KEY (place_id) REFERENCES place (id)'
        );
        $this->addSql(
            'ALTER TABLE service_payment ADD CONSTRAINT FK_A2ACD691ED5CA9E6
                FOREIGN KEY (service_id) REFERENCES service (id)'
        );
        $this->addSql(
            'ALTER TABLE service_payment ADD CONSTRAINT FK_A2ACD691DA6A219
                FOREIGN KEY (place_id) REFERENCES place (id)'
        );
    }// end up()
